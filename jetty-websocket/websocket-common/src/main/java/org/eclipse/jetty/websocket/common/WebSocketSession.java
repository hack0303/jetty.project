...
public class WebSocketSession extends ContainerLifeCycle implements Session, RemoteEndpointFactory, WebSocketSessionScope, IncomingFrames, Connection.Listener
{
    ...
    public void disconnect()
    {
        ...
        callApplicationOnClose(new CloseInfo(StatusCode.NO_CLOSE, "Harsh Disconnect"));
    }
    ...
    public RemoteEndpoint getRemote()
    {
        ...
        {
            throw new WebSocketException("RemoteEndpoint unavailable=");
        }
    ...
    {
        if(LOG_OPEN.isDebugEnabled())
            LOG_OPEN.debug("[{}] {}.onSessionClosed()",policy.getBehavior(),this.getClass().getSimpleName());
    ...
    {
        if(LOG_OPEN.isDebugEnabled())
            LOG_OPEN.debug("[{}] {}.onSessionOpened()",policy.getBehavior(),this.getClass().getSimpleName());
        open();
    }
